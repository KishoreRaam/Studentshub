    ...
    >
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="relative group flex-shrink-0">
          <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-blue-500 to-green-500 p-[3px] shadow-lg">
            <div className="w-full h-full rounded-full bg-white dark:bg-gray-800 flex items-center justify-center overflow-hidden">
              {user.avatar ? (
                ...
                <span className="text-2xl md:text-3xl font-bold bg-gradient-to-br from-blue-600 to-green-600 bg-clip-text text-transparent">
          ...
          <div className="absolute bottom-0 right-0 w-6 h-6 md:w-7 md:h-7 bg-green-500 border-4 border-white dark:border-gray-800 rounded-full shadow-md"></div>
        </div>
